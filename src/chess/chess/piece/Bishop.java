...
public class Bishop extends Piece {
  ...
  protected void computePossibleMoves(Chessboard board, MoveArrayList possibleMoves) {
	...
	System.out.println("info string yo");
	// Defining all moves
	for ( int i = 1; i < 8 ; i++ ) {
		int moveRowUR = row - i ;
  ...
  protected boolean verificationPossibleMove(Chessboard board, MoveArrayList possibleMoves,
		  int row, int column, int moveRow,int moveColumn) {
